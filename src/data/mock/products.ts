...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    brand: 'Alvora',
    inStock: true,
    images: ['/images/products/restore-moisture-cream.jpg'],
    features: [],
    safetyInfo: 'Apply 2-3 drops to clean, slightly damp skin. Gently press into face and neck until fully absorbed. Follow with moisturizer. Use morning and night.',
    specifications: { 'Ingredients': 'Water, Niacinamide, Glycerin, Sodium Hyaluronate, Panthenol, Centella Asiatica Extract, Ceramide NP, Phenoxyethanol, Ethylhexylglycerin.' },
  ...
  },
  {
    ...
    brand: 'Alvora',
    inStock: true,
    images: ['/images/products/hydrating-essence.jpg'],
    features: [],
    safetyInfo: 'Apply 2-3 drops to clean, slightly damp skin. Gently press into face and neck until fully absorbed. Follow with moisturizer. Use morning and night.',
    specifications: { 'Ingredients': 'Water, Niacinamide, Glycerin, Sodium Hyaluronate, Panthenol, Centella Asiatica Extract, Ceramide NP, Phenoxyethanol, Ethylhexylglycerin.' },
  ...
  },
  {
    ...
    brand: 'Alvora',
    inStock: true,
    images: ['https://images.unsplash.com/photo-1608248593842-8021c6a8f118?auto=format&fit=crop&w=800&q=80'],
    features: [],
    safetyInfo: 'Apply 2-3 drops to clean, slightly damp skin. Gently press into face and neck until fully absorbed. Follow with moisturizer. Use morning and night.',
    specifications: { 'Ingredients': 'Water, Niacinamide, Glycerin, Sodium Hyaluronate, Panthenol, Centella Asiatica Extract, Ceramide NP, Phenoxyethanol, Ethylhexylglycerin.' },
  ...
  },
  {
    ...
    brand: 'Alvora',
    inStock: true,
    images: ['https://images.unsplash.com/photo-1556228720-192b673626f1?auto=format&fit=crop&w=800&q=80'],
    features: [],
    safetyInfo: 'Apply 2-3 drops to clean, slightly damp skin. Gently press into face and neck until fully absorbed. Follow with moisturizer. Use morning and night.',
    specifications: { 'Ingredients': 'Water, Niacinamide, Glycerin, Sodium Hyaluronate, Panthenol, Centella Asiatica Extract, Ceramide NP, Phenoxyethanol, Ethylhexylglycerin.' },
