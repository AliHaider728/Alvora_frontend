...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    features: [],
    safetyInfo: 'Apply 2-3 drops to clean, slightly damp skin. Gently press into face and neck until fully absorbed. Follow with moisturizer. Use morning and night.',
    specifications: { 'Ingredients': 'Water, Niacinamide, Glycerin, Sodium Hyaluronate, Panthenol, Centella Asiatica Extract, Ceramide NP, Phenoxyethanol, Ethylhexylglycerin.' },
