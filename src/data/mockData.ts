...
export const INITIAL_ORDERS: Order[] = [
  ...
  },
  {
    ...
    phone: '+1 555-0811',
    items: [
      { productId: 'p-105', name: 'MagnaTiles 100-Piece Rainbow Magnetic Building Set', quantity: 1, price: 6999, image: 'https://images.unsplash.com/photo-1587654780291-39c9404d746b?auto=format&fit=crop&w=200&q=80' }
    ],
    subtotal: 69.99,
    discount: 0,
    shipping: 0,
