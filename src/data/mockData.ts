...
export const INITIAL_ORDERS: Order[] = [
  {
    ...
    phone: '+1 555-0192',
    items: [
      { productId: 'p-101', name: 'Galaxy Explorer Cosmic Rocket Ship', quantity: 1, price: 49.99, image: 'https://images.unsplash.com/photo-1541185933-ef5d8ed016c2?auto=format&fit=crop&w=200&q=80' },
      { productId: 'p-106', name: 'Safari Quest 3D Wooden Animal Puzzle', quantity: 1, price: 19.99, image: 'https://images.unsplash.com/photo-1610890716171-6b1bb98ffd09?auto=format&fit=crop&w=200&q=80' }
    ],
    subtotal: 69.98,
    discount: 5.00,
    shipping: 0,
  ...
  },
  {
    ...
    phone: '+1 555-0811',
    items: [
      { productId: 'p-105', name: 'MagnaTiles 100-Piece Rainbow Magnetic Building Set', quantity: 1, price: 69.99, image: 'https://images.unsplash.com/photo-1587654780291-39c9404d746b?auto=format&fit=crop&w=200&q=80' }
    ],
    subtotal: 69.99,
    discount: 0,
    shipping: 0,
  ...
  },
  {
    ...
    phone: '+1 555-0377',
    items: [
      { productId: 'p-102', name: 'CuddlePal Plush Giant Teddy Bear', quantity: 1, price: 34.99, image: 'https://images.unsplash.com/photo-1559454403-b8fb88521f11?auto=format&fit=crop&w=200&q=80' }
    ],
    subtotal: 34.99,
    discount: 0,
    shipping: 5.99,
