...
export const AGE_GROUPS: AgeGroupOption[] = [
  { id: '0-2', name: 'Sensitive Skin', label: 'Sensitive', range: '0-2', color: 'bg-rose-50 text-[#C48B80] border-rose-200', icon: 'Shield' },
  { id: '3-5', name: 'Dry Skin', label: 'Dry', range: '3-5', color: 'bg-amber-50 text-amber-700 border-amber-200', icon: 'Droplet' },
  { id: '6-8', name: 'Oily Skin', label: 'Oily', range: '6-8', color: 'bg-[#C48B80] text-[#C48B80] border-[#C48B80]', icon: 'Droplets' },
  { id: '9-12', name: 'Combination', label: 'Combo', range: '9-12', color: 'bg-[#C48B80] text-[#C48B80] border-[#C48B80]', icon: 'Blend' },
