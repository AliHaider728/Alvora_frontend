  ...
  return (
    <div className="space-y-4">
      ...
      {attributes.map((attr, index) => (
        <div key={attr.id} className="border border-[#E7D9D0] rounded-xl p-4 bg-[#FAF6F2] flex gap-4">
          <div className="pt-2 cursor-grab text-[#1A1A1A]/40 hover:text-[#1A1A1A]/70">
          ...
          <div className="flex-1 space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-[#1A1A1A]/50 capitalize flex items-center gap-1">
                  ...
                  <select 
                    ...
                    className="ml-1 bg-transparent border-none p-0 text-sm font-medium text-[#1A1A1A]/80 focus:ring-0 cursor-pointer"
                  >
                ...
                {attr.source === 'custom' ? (
                  ...
                  <div className="flex flex-wrap gap-2 pt-1">
                    ...
                    {attr.terms.filter(t => !t.isArchived).length === 0 && (
                      <span className="text-sm text-[#1A1A1A]/50 italic">No terms defined globally.</span>
                    )}
                  </div>
                )}
              </div>
            ...
            <div className="flex items-center gap-6 pt-2">
              <label className="flex items-center gap-2 text-sm text-[#1A1A1A]/80 cursor-pointer">
                <input
                  type="checkbox"
