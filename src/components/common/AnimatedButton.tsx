  ...
  ({ href, variant = 'primary', size = 'md', className = '', children, ...props }, ref) => {
    ...
    const SVGs = (
      <>
        ...
        <div className={`anim-slay-1 absolute top-0 right-0 w-[25px] pointer-events-none will-change-transform drop-shadow-[2px_2px_3px_rgba(0,0,0,0.3)] ${svgColor}`}>
        ...
        <div className={`anim-slay-2 absolute top-0 left-[25px] w-[12px] pointer-events-none will-change-transform drop-shadow-[2px_2px_3px_rgba(0,0,0,0.5)] ${svgColor}`}>
        ...
        <div className={`anim-slay-3 absolute top-0 left-0 w-[18px] pointer-events-none will-change-transform drop-shadow-[2px_2px_3px_rgba(0,0,0,0.5)] ${svgColor}`}>
