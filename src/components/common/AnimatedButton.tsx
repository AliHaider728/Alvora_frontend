  ...
  ({ href, variant = 'primary', size = 'md', hideLeaves = false, className = '', children, ...props }, ref) => {
    ...
    const SVGs = (
      <>
        ...
        <div className={`anim-slay-2 absolute top-0 left-[25px] w-[10px] sm:w-[12px] pointer-events-none will-change-transform drop-shadow-[2px_2px_3px_rgba(0,0,0,0.5)] ${svgColor}`}>
