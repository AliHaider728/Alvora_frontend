...
export const FloatingWhatsApp: React.FC = () => {
  ...
  return (
    <>
      ...
      `}</style>
      <a
        href={`https://wa.me/923107172222?text=${encodeURIComponent("Hi Alvora Skincare! 👋 I'm interested in your skincare products and would like some more information. Can you please help me?")}`}
        target="_blank"
