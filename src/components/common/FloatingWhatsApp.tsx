    ...
    <>
      <style>{`
        ...
        .animate-custom-bounce {
          animation: custom-bounce 4s ease infinite;
        }
        .animate-custom-bounce:hover {
      ...
      `}</style>
      <a
        href={`https://wa.me/923107172222?text=${encodeURIComponent("Hi Alvora Skincare! ðŸ‘‹ I'm interested in your skincare products and would like some more information. Can you please help me?")}`}
        target="_blank"
