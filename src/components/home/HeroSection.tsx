...
export const HeroSection: React.FC<{ featuredHref?: string }> = ({ featuredHref }) => {
  return (
    <section className="relative min-h-[100dvh] w-full bg-[url('/images/home-hero-mobile.jpg')] sm:bg-[url('/images/Alvora_hero_background.avif')] bg-cover bg-bottom sm:bg-center bg-scroll sm:bg-fixed bg-no-repeat overflow-hidden">
