...
export const HeroSection: React.FC<{ featuredHref?: string }> = ({ featuredHref }) => {
  return (
    <section className="relative min-h-[100dvh] w-full bg-[url('/herowebp-mobile.webp')] sm:bg-[url('/herowebp.webp')] bg-cover bg-center bg-scroll sm:bg-fixed bg-no-repeat overflow-hidden">
      {/* 
