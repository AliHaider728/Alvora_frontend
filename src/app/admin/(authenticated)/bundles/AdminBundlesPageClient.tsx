  ...
  return (
    <div className="space-y-6 font-sans">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <button type="button" onClick={() => setEditing({})} className="flex items-center justify-center gap-2 rounded-2xl bg-[#C48B80] px-5 py-2.5 text-xs font-bold text-white shadow-md">
      ...
      <div className="w-full max-w-2xl bg-white rounded-3xl p-6 shadow-xl my-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <button type="submit" disabled={saving} className="px-5 py-2.5 rounded-xl font-bold text-white bg-[#C48B80] text-sm flex items-center gap-2">
