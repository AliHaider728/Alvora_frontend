...
export const AdminSettingsPageClient: React.FC = () => {
    ...
    <div className="space-y-6 font-heading">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          disabled={saving}
          className="px-8 py-3.5 rounded-xl bg-[#1A1A1A] hover:bg-[#333333] text-white font-heading font-extrabold text-xs shadow-md flex items-center gap-2 disabled:opacity-50"
        >
